...
export async function generateMetadata({ params }) {
  ...
  const toolsInCategory = await Tool.find({
    $or: [
      { categories: { $elemMatch: { $regex: new RegExp(`^${readableCategory}$`, "i") } } },
      { category:   { $elemMatch: { $regex: new RegExp(`^${readableCategory}$`, "i") } } },
    ],
  }).lean();
      ...
      <div className="min-h-screen mt-15 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="relative min-h-screen w-full overflow-hidden flex flex-col justify-center bg-gradient-to-b from-white via-blue-50 to-white text-gray-900">
          ...
          <div className="absolute top-0 left-0 right-0 flex items-center justify-between px-8 pt-8">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 inline-flex items-center justify-center gap-3 px-4 py-2 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 border border-blue-200 text-blue-700 font-medium text-sm shadow-sm">
          ...
          {/* Center Hero Content */}
          <div className="relative z-10 flex flex-col items-center text-center px-6 sm:px-8 mt-20">
