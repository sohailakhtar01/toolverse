        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <h1 className="text-3xl font-spaceGrotesk sm:text-4xl font-bold text-gray-900 mb-3">
                      {tool.name}
                    </h1>
                    <p className="text-lg font-spaceGrotesk text-gray-600 mb-4 leading-relaxed">
                      {tool.description}
                    </p>
                    <div className="flex flex-wrap font-spaceGrotesk items-center gap-3">
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getPriceBadgeStyle(tool.price)}`}>
                        {tool.price}
                      </span>
                      {tool.rating && (
                        <div className="flex items-center font-spaceGrotesk gap-1">
                          ...
                          <span className="text-sm font-spaceGrotesk font-medium text-gray-700">{tool.rating}</span>
                        </div>
                      )}
                    </div>
                  </div>
              ...
              {/* Features Section */}
              <div className="bg-white rounded-2xl font-spaceGrotesk shadow-lg border border-gray-100 p-6 sm:p-8">
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Key Features</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {tool.tags.map((tag, index) => (
                    <div key={index} className="flex items-center font-spaceGrotesk gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              {tool.overview && (
                <section className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8">
                  ...
                  <p className="text-gray-700 font-spaceGrotesk leading-relaxed">{tool.overview}</p>
                </section>
              )}
              ...
              <section className="bg-white font-spaceGrotesk rounded-2xl shadow-lg border border-gray-100 p-6 sm:p-8">
                <h3 className="text-xl font-semibold font-spaceGrotesk text-gray-900 mb-4">
