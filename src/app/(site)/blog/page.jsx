            ...
            <div className="text-center max-w-2xl mx-auto">
              <div className="mb-8">
                ...
                <h1 className="text-4xl font-bold text-gray-900 mb-4">
                  AI Tools Insights & Expert Guides
                </h1>
                <p className="text-xl text-gray-600">
                  ToolsVerse publishes expert-written articles, reviews, and guides
                  covering AI tools, productivity software, and automation solutions.
                  New content is added regularly to help users make informed decisions.
                </p>
                <ul className="mt-6 text-left max-w-xl mx-auto space-y-2 text-gray-700">
                  <li>• In-depth AI tool reviews and comparisons</li>
                  <li>• Best AI tools by category and use-case</li>
                  <li>• Practical guides for students, creators, and businesses</li>
                </ul>
              </div>
              <Link
                href="/"
