            ...
            <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl 
                ...
                <form onSubmit={handleSearchSubmit} className="w-full">
                    <div className="relative group">
                        ...
                        <div className="absolute -inset-1 bg-gradient-to-r from-purple-400 via-indigo-400 to-blue-400 rounded-2xl opacity-0 group-hover:opacity-20 blur-xl transition-all duration-700" />
                        
                        <div className="relative flex items-center gap-3 px-5 py-4 sm:px-6 sm:py-5 
                            bg-gradient-to-br from-gray-50 to-indigo-50/30
                            border-2 border-indigo-100/60 rounded-2xl
                            focus-within:bg-white focus-within:border-indigo-300 
                            ...
                            <input
                                ...
                                className="flex-1 bg-transparent outline-none text-base sm:text-lg text-gray-700 placeholder-gray-400"
                            />
                            
                            <button
                                type="submit"
                                className="px-5 cursor-pointer py-2.5 bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 
