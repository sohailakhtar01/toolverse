...
export default function ToolSubmissionForm() {
  ...
  const [categories, setCategories] = useState([
    "3D Model", "AI Agents", "AI Characters", "AI Chat & Assistant",
    "AI detection", "AI Simulation", "AI Useful", "Toolsverse Section",
    "Amazing", "Art", "Assistant Code", "Assistive technology (AT)",
    "Audio Editing", "Automation", "Avatars", "Business",
    "ChatBots", "Customer Support", "Data & Analytics", "Dating & Relationships",
    "Developer Tools", "E-commerce", "E-mail", "Education / Studies",
    "Extensions ChatGPT", "Face Swap & DeepFake", "Fashion", "Files & Spreadsheets",
    "Finance", "Future Tools", "Games", "Github Projects",
    "Healthcare", "Human Resources", "Image editing", "Image Generators",
    "Latest AI", "Legal Assistants", "Life Assistants", "LLM models",
    "Logo creation", "Marketing", "Memory", "Music",
    "No Code/Low Code", "Presentation", "Productivity", "Prompts & Aids",
    "Real Estate / Architect", "Research & Science", "Robots and Devices", "Sales & Conversion",
    "Search Engine", "SEO", "Social Networks", "Storytelling Generator",
    "Summarizer", "Super Tools", "Text Generators", "Text To Speech",
    "Text-to-video", "Transcriber", "Translation",
    "Travel", "Video Edition", "Video Generators", "Voice Cloning",
    "Websites & Design", "Writing & Web SEO"
  ]);
