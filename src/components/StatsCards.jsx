      ...
      <div className="relative z-10">
        ...
        {showMore && (
          <button
            ...
            className="mt-5 w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group/btn"
          >
            <span>{isExpanded ? 'Show Less' : `Show All ${categories.length} Categories`}</span>
            <ChevronDown
              className={`w-5 h-5 transition-transform duration-500 group-hover/btn:scale-110 ${
